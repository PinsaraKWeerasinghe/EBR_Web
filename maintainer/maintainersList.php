...
while($query_execute=mysqli_fetch_assoc($is_query_run)){
	echo"<tr><td>".$query_execute["maintainer_ID"]."</td><td>".$query_execute["first_name"]."</td><td>".$query_execute["second_name"]."</td><td>".$query_execute["current_state"]."</td><td>".$query_execute["incidet_id"]."</td></tr>";
}
echo"</table>";
