...
while($query_execute=mysqli_fetch_assoc($is_query_run)){
	echo"<tr><td>".$query_execute["incident_id"]."</td><td><a href='map.php?lat=".$query_execute["lat"]."&long=".$query_execute["lng"]."'>".$query_execute["location"]."</a></td><td>".$query_execute["insident_type"]."</td><td>".$query_execute["comment"]."</td><td><a href='incidentImage.php?id=".$query_execute["incident_id"]."' >View Image</a></td><td>".$query_execute["state"]." </td></tr>";
}
echo"</table>";
