                            ...
                            <div class="col-md-7">
                                <div class="carousel-content">
                                    ...
                                    <div class="animation animated-item-2">
                                        Target is give relaible service through the iternet.
                                    </div>
                                    <a class="btn-slide animation animated-item-3" href="issues.php">Learn More</a>
                                    <a class="btn-slide white animation animated-item-3" href="maintainers.php">Get Started</a>
                                </div>
                            </div>
                ...
                <div class="item" style="background-image: url(images/slider/bg2.jpg)">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-7">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">Assign Maintainers for Suitable works</h1>
                                    <div class="animation animated-item-2">
                                        Identify the Maintainers and Assign to suitable tasks.
                                    </div>
                                    <a class="btn-slide white animation animated-item-3" href="issues.php">Issues</a>
                                    <a class="btn-slide animation animated-item-3" href="maintainers.php">Maintainers</a>
                                </div>
                            </div>
                ...
                <div class="item" style="background-image: url(images/slider/bg3.jpg)">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-7">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">Control Center on Your Hand</h1>
                                    <div class="animation animated-item-2">
                                        All controlling cases handled by this system. Therefore be careful !
                                    </div>
                                    <a class="btn-slide white animation animated-item-3" href="issues.php">Issues</a>
                                    <a class="btn-slide animation animated-item-3" href="maintainers.php">Maintainers</a>
                                </div>
